...
public class KeyBinding {
    ...
    public static final KeyMapping CONFIGURE_RADIO_KEY = new KeyMapping(KEY_CONFIGURE_RADIO, KeyConflictContext.IN_GAME, 
        InputConstants.Type.KEYSYM, GLFW.GLFW_KEY_C, KEY_CATEGORY_RADIO);
}
